    ...
    <section className="animate-fade-in-up rounded-2xl border border-emerald-500/25 bg-emerald-950/25 p-4 shadow-lg shadow-black/20 backdrop-blur-xl">
      <div className="mb-3 flex items-center justify-between">
        <h2 className="flex items-center gap-2 text-sm font-semibold text-emerald-300">
          <span className="inline-flex h-6 w-6 animate-pop-in items-center justify-center rounded-full bg-emerald-500/20 text-emerald-300">
            ✓
          </span>
      ...
      <a
        href={url}
        download={fileName}
        className="mt-3 inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-emerald-600 to-teal-600 px-4 py-2 text-sm font-semibold text-white transition-all duration-300 hover:brightness-110 active:scale-[0.97]"
      >
